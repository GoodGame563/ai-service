    ...
    messages = [
        {"role": "system", "content": """
           Ты — эксперт по созданию описаний товаров для маркетплейсов. Твоя задача — сравнить описание и ключевые слова нашего товара с описаниями и ключевыми словами конкурентов и улучшить его.
            ...
            Выдели ключевые слова и фразы из описаний конкурентов, которых нет в нашем описании, но которые могут сделать наше предложение более привлекательным, но писать их нельзя.

            Перепиши описание нашего товара так, чтобы оно:

            Соответствовало формату карточки товара на маркетплейсе.
            Было кратким, понятным и ярким (не более 80–100 слов).
            ...
            Чтоб слова не повторялись слишком часто, используй синонимы подходящим по контексту, но если нет хорошего синонима используй повтор.
