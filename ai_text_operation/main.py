    ...
    messages = [
        {"role": "system", "content": """
            Прочитай текст, проанализируй его, и переформулируй так, чтобы он:
                ...
                Не нужно писать название продукта и бренд.
                Нужно писать только новое описание
            Пример:
...
name = "Спрей термозащита для волос несмываемый с кератином, 300 мл"
name_brand= "Ural Lab"
...
generate_new_text_without_seo_words(text, name, name_brand)